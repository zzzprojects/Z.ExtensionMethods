...
Public Module Extensions_787
	...
	Public Function ReadAllLines(this As FileInfo) As [String]()
	...
	''' <exception cref="T:System.Security.SecurityException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function ReadAllLines(this As FileInfo, encoding As Encoding) As [String]()
