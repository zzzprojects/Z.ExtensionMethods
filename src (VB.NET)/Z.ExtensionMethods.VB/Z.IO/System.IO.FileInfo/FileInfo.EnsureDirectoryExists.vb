...
Public Module Extensions_779
	...
	Public Function EnsureDirectoryExists(this As FileInfo) As DirectoryInfo
	...
	''' </exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function EnsureDirectoryExists(this As FileInfo, directorySecurity As DirectorySecurity) As DirectoryInfo
