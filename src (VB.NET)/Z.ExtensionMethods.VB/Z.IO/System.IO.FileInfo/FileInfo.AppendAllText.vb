...
Public Module Extensions_776
	...
	Public Sub AppendAllText(this As FileInfo, contents As [String])
	...
	''' <exception cref="T:System.Security.SecurityException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Sub AppendAllText(this As FileInfo, contents As [String], encoding As Encoding)
