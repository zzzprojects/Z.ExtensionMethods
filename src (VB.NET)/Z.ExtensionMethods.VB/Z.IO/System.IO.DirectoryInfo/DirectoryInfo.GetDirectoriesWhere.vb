...
Public Module Extensions_766
	...
	Public Function GetDirectoriesWhere(this As DirectoryInfo, predicate As Func(Of DirectoryInfo, Boolean)) As DirectoryInfo()
		Return Directory.EnumerateDirectories(this.FullName).[Select](Function(x) New DirectoryInfo(x)).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetDirectoriesWhere(this As DirectoryInfo, searchPattern As [String], predicate As Func(Of DirectoryInfo, Boolean)) As DirectoryInfo()
		Return Directory.EnumerateDirectories(this.FullName, searchPattern).[Select](Function(x) New DirectoryInfo(x)).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetDirectoriesWhere(this As DirectoryInfo, searchPattern As [String], searchOption As SearchOption, predicate As Func(Of DirectoryInfo, Boolean)) As DirectoryInfo()
		Return Directory.EnumerateDirectories(this.FullName, searchPattern, searchOption).[Select](Function(x) New DirectoryInfo(x)).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetDirectoriesWhere(this As DirectoryInfo, searchPatterns As [String](), predicate As Func(Of DirectoryInfo, Boolean)) As DirectoryInfo()
		Return searchPatterns.SelectMany(Function(x) this.GetDirectories(x)).Distinct().Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetDirectoriesWhere(this As DirectoryInfo, searchPatterns As [String](), searchOption As SearchOption, predicate As Func(Of DirectoryInfo, Boolean)) As DirectoryInfo()
		Return searchPatterns.SelectMany(Function(x) this.GetDirectories(x, searchOption)).Distinct().Where(Function(x) predicate(x)).ToArray()
	End Function
End Module
