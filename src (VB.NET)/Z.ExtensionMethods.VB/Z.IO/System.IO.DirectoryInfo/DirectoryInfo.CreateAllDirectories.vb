...
Public Module Extensions_757
	...
	Public Function CreateAllDirectories(this As DirectoryInfo) As DirectoryInfo
	...
	''' </exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function CreateAllDirectories(this As DirectoryInfo, directorySecurity As DirectorySecurity) As DirectoryInfo
