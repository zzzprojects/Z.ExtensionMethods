...
Public Module Extensions_765
	...
	Public Function GetDirectories(this As DirectoryInfo, searchPatterns As [String]()) As DirectoryInfo()
		Return searchPatterns.SelectMany(Function(x) this.GetDirectories(x)).Distinct().ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetDirectories(this As DirectoryInfo, searchPatterns As [String](), searchOption As SearchOption) As DirectoryInfo()
		Return searchPatterns.SelectMany(Function(x) this.GetDirectories(x, searchOption)).Distinct().ToArray()
	End Function
End Module
