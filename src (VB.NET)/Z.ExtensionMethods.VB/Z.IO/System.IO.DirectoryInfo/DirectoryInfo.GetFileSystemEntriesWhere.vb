...
Public Module Extensions_770
	...
	Public Function GetFileSystemEntriesWhere(this As DirectoryInfo, predicate As Func(Of String, Boolean)) As String()
		Return Directory.EnumerateFileSystemEntries(this.FullName).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetFileSystemEntriesWhere(this As DirectoryInfo, searchPattern As [String], predicate As Func(Of String, Boolean)) As String()
		Return Directory.EnumerateFileSystemEntries(this.FullName, searchPattern).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetFileSystemEntriesWhere(this As DirectoryInfo, searchPattern As [String], searchOption As SearchOption, predicate As Func(Of String, Boolean)) As String()
		Return Directory.EnumerateFileSystemEntries(this.FullName, searchPattern, searchOption).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetFileSystemEntriesWhere(this As DirectoryInfo, searchPatterns As [String](), predicate As Func(Of String, Boolean)) As String()
		Return searchPatterns.SelectMany(Function(x) Directory.EnumerateFileSystemEntries(this.FullName, x)).Distinct().Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetFileSystemEntriesWhere(this As DirectoryInfo, searchPatterns As [String](), searchOption As SearchOption, predicate As Func(Of String, Boolean)) As String()
		Return searchPatterns.SelectMany(Function(x) Directory.EnumerateFileSystemEntries(this.FullName, x, searchOption)).Distinct().Where(Function(x) predicate(x)).ToArray()
	End Function
End Module
