...
Public Module Extensions_768
	...
	Public Function GetFilesWhere(this As DirectoryInfo, predicate As Func(Of FileInfo, Boolean)) As FileInfo()
		Return Directory.EnumerateFiles(this.FullName).[Select](Function(x) New FileInfo(x)).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetFilesWhere(this As DirectoryInfo, searchPattern As [String], predicate As Func(Of FileInfo, Boolean)) As FileInfo()
		Return Directory.EnumerateFiles(this.FullName, searchPattern).[Select](Function(x) New FileInfo(x)).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetFilesWhere(this As DirectoryInfo, searchPattern As [String], searchOption As SearchOption, predicate As Func(Of FileInfo, Boolean)) As FileInfo()
		Return Directory.EnumerateFiles(this.FullName, searchPattern, searchOption).[Select](Function(x) New FileInfo(x)).Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetFilesWhere(this As DirectoryInfo, searchPatterns As [String](), predicate As Func(Of FileInfo, Boolean)) As FileInfo()
		Return searchPatterns.SelectMany(Function(x) this.GetFiles(x)).Distinct().Where(Function(x) predicate(x)).ToArray()
	End Function
	...
	''' <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
	<System.Runtime.CompilerServices.Extension> _
	Public Function GetFilesWhere(this As DirectoryInfo, searchPatterns As [String](), searchOption As SearchOption, predicate As Func(Of FileInfo, Boolean)) As FileInfo()
		Return searchPatterns.SelectMany(Function(x) this.GetFiles(x, searchOption)).Distinct().Where(Function(x) predicate(x)).ToArray()
	End Function
End Module
